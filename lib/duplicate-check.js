        ...
        this.redisClient.get( redisKey, function( err, redisRes ){
            if( !!err ){
                ...
                if( this.buildHash( req ) === redisRes ){
                    ...
                    this.setHash( req, res, next, redisKey, this.redisClient );
                    return next();
                }
            }
        }.bind( this ) );
...
DuplicateCheck.prototype.buildHash = function( req ){
    ...
    if( this.ignoreProperties.length > 0 ){
        this.ignoreProperties.forEach( function( item ){
...
DuplicateCheck.prototype.setHash = function( req, res, next, redisKey ){
